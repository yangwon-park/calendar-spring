...
import com.calendar.couple.couple.infrastructure.CoupleMapper.toDomain

/**
 * 특정 계정이 포함된 커플 정보를 조회합니다.
 * account1_id 또는 account2_id가 일치하는 커플을 찾습니다.
 */
fun CoupleRepository.findByAccountId(accountId: Long): Couple? =
	findByAccount1IdOrAccount2Id(accountId, accountId)?.toDomain()
...
fun CoupleRepository.deleteByAccountId(accountId: Long) = deleteByAccount1IdOrAccount2Id(accountId, accountId)